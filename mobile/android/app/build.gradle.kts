...
android {
    namespace = "com.focusmother.android"
    compileSdk = 34
...
dependencies {
    ...
    // Retrofit + OkHttp (for Claude API and Ready Player Me)
    ...
    testImplementation("androidx.test.ext:junit:1.1.5") // Added for unit tests
