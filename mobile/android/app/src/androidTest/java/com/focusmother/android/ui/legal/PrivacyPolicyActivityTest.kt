...
/**
 * Instrumented tests for PrivacyPolicyActivity.
 *
 * Tests the Privacy Policy activity functionality including:
...
class PrivacyPolicyActivityTest {
    ...
    fun activityLaunches_inViewOnlyMode_successfully() {
        // Given
        val intent = Intent(ApplicationProvider.getApplicationContext(), PrivacyPolicyActivity::class.java)

        // When
        val scenario = ActivityScenario.launch<PrivacyPolicyActivity>(intent)
    ...
    fun activityLaunches_inOnboardingMode_successfully() {
        // Given
        val intent = PrivacyPolicyActivity.createIntent(
    ...
    fun createIntent_withShowAcceptFalse_launchesCorrectly() {
        ...
        // Then
        assert(intent.component?.className == PrivacyPolicyActivity::class.java.name)
